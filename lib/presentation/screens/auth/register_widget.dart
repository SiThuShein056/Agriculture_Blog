          ...
          children: [
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                onEditingComplete: registerBloc.passWordFocus.requestFocus,
                validator: (value) {
            ...
            Row(
              ...
              children: [
                TextButton(
                    onPressed: () {}, child: const Text("Suggess Password")),
                CustomOutliinedButton(function: register, lable: "Register"),
              ],
            ),
          ],
        ),
